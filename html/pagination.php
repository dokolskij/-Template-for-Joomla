...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="glyphicon glyphicon-menu-left"></i>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		$display = '<i class="glyphicon glyphicon-menu-right"></i>';
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="disabled"><a><i class="glyphicon glyphicon-menu-left"></i></a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="disabled"><a><i class="glyphicon glyphicon-menu-right"></i></a></li>';
	}
